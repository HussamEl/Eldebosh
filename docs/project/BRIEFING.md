...
| Counting | *written* = has real text (`stage` ≥ `written`). Generated by `npm run state`, never typed |
| Battery cluster | **8 of 11 have text** — 2 published · 6 waiting on review · 3 blocked |
