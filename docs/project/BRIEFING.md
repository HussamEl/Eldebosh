...
## 6. Current state — measured `2026-09-04`

All figures come from `npm run state`. They are generated, never typed. If a
number here disagrees with the command, the command is right.

| Item | State |
|---|---|
| Site | **70 generated pages**, two languages |
| **Deployment** | 🟢 Automatic — GitHub builds and checks, the host pulls. No manual step |
| Automated checks | **14 local + 1 in CI**, all green · 32 claim cases · 28/28 in Chromium |
| Products | **23** · verified 7 · photographed 13 · **8 waiting on an ASIN** |
| Content | **32 Swedish documents, every one reachable** · 11 with finished text · 2 written and awaiting review · 19 declared skeletons |
| Legal and standing pages | 6 · **all written** · none carries draft text, and the build now fails if one does |
| Battery cluster | **11 of 11 published** — the first wave is complete |
