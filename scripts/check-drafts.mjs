 ...
 *
 * الحارس يبلّغ ولا يُفشل البناء — بعدُ. يُقلب إلى فاشل (رمز خروج 1) يوم تصل
 * النصوص الحقيقية، فلا يعود العطب ممكناً بصمت. حتى ذلك اليوم إفشاله يمنع حسام
 * من نشر المحتوى الذي يصلحه.
 *
...
/** يوم يصير هذا `true` يفشل البناء بدل أن يبلّغ فقط. */
const FATAL = false;
